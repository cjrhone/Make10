...
public class AudioManager : MonoBehaviour {
  ...
  private void ApplyVolumeSettings() {
    ...
    if (pitchedSfxSource != null) {
      pitchedSfxSource.volume = sfxVolume;
    }
  ...
  public void SetSFXVolume (float volume) {
    ...
    if (pitchedSfxSource != null) {
      pitchedSfxSource.volume = volume;
    }

    if (timeWarningSource != null) {
      timeWarningSource.volume = volume;
    }
  ...
  public void PlayZenMusic() {
    PlayMusic(zenMusic != null ? zenMusic : gameMusic, true);
  }
  ...
  public void PlayHotStreakMusic() {
    PlayMusic(hotStreakMusic, true);
  }
  ...
  public void PlayConvergenceSound() {
    PlaySFX(convergenceSFX);
  }

  public void PlayTenPopSound() {
    PlayTenPopSound(1);
  }
  ...
  public void PlayTenPopSound (int chainCount) {
    if (pitchedSfxSource == null || tenPopSFX == null) {
      return;
    }

    var pitch = Mathf.Min(1.0f + (chainCount - 1) * 0.08f, 1.5f);
  ...
  public void PlayMultiplierIncrease() {
  ...
  public void PlayScoreTickSmall() {
    if (Time.time - lastScoreTickTime < SCORE_TICK_MIN_INTERVAL) {
      return;
    }
  ...
  public void PlayComboSound() {
    PlaySFX(comboMergeSFX);
  }

  public void PlayUltraComboSound() {
    PlaySFX(ultraComboSFX);
  }
  ...
  public void StartTimeWarning() {
    if (timeWarningSource == null || timeWarningSFX == null || timeWarningSource.isPlaying) {
      return;
    }
  ...
  public void StopTimeWarning() {
    if (timeWarningSource == null || timeWarningSource.clip != timeWarningSFX) {
      return;
    }
