...
public static class UIStyleGuide {
  ...
  public static readonly Vector2 WindowSizeSmall = new(800, 500);

  /// <summary>Medium dialog (e.g., item details, simple choices) - increased height for better readability</summary>
  public static readonly Vector2 WindowSizeMedium = new(900, 950);

  /// <summary>Large panel (e.g., shop, inventory, upgrade confirm)</summary>
  public static readonly Vector2 WindowSizeLarge = new(980, 1200);

  /// <summary>Extra large/near-fullscreen (e.g., tutorials, settings)</summary>
  public static readonly Vector2 WindowSizeXLarge = new(1000, 1500);
  ...
  public static readonly Color ColorOverlay = new(0f, 0f, 0f, 0.8f);

  /// <summary>Window background</summary>
  public static readonly Color ColorWindowBg = new(0.06f, 0.06f, 0.10f, 1f);

  /// <summary>Header bar background</summary>
  public static readonly Color ColorHeader = new(0.22f, 0.16f, 0.32f, 1f);

  /// <summary>Gold border/frame</summary>
  public static readonly Color ColorBorder = new(0.85f, 0.7f, 0.3f, 1f);

  /// <summary>Title text (gold/cream)</summary>
  public static readonly Color ColorTitleText = new(1f, 0.95f, 0.75f, 1f);
  ...
  public static readonly Color ColorTextPrimary = new(0.95f, 0.95f, 0.95f, 1f);

  /// <summary>Secondary text (light gray)</summary>
  public static readonly Color ColorTextSecondary = new(0.75f, 0.75f, 0.8f, 1f);

  /// <summary>Muted/disabled text</summary>
  public static readonly Color ColorTextMuted = new(0.5f, 0.5f, 0.55f, 1f);

  /// <summary>Accent text (for highlights)</summary>
  public static readonly Color ColorTextAccent = new(1f, 0.85f, 0.4f, 1f);
  ...
  public static readonly Color ColorButtonPrimary = new(0.2f, 0.5f, 0.25f, 1f);

  /// <summary>Secondary action button (blue)</summary>
  public static readonly Color ColorButtonSecondary = new(0.2f, 0.35f, 0.6f, 1f);

  /// <summary>Neutral/default button (purple)</summary>
  public static readonly Color ColorButtonNeutral = new(0.35f, 0.28f, 0.5f, 1f);

  /// <summary>Danger/cancel button (red)</summary>
  public static readonly Color ColorButtonDanger = new(0.6f, 0.2f, 0.2f, 1f);

  /// <summary>Disabled button</summary>
  public static readonly Color ColorButtonDisabled = new(0.3f, 0.3f, 0.35f, 1f);
  ...
  public static readonly Color ColorSuccess = new(0.3f, 0.7f, 0.35f, 1f);

  /// <summary>Warning (orange)</summary>
  public static readonly Color ColorWarning = new(0.9f, 0.6f, 0.2f, 1f);

  /// <summary>Error/negative (red)</summary>
  public static readonly Color ColorError = new(0.8f, 0.25f, 0.25f, 1f);

  /// <summary>Info/highlight (cyan)</summary>
  public static readonly Color ColorInfo = new(0.3f, 0.7f, 0.9f, 1f);
  ...
  public static readonly Color ColorRarityCommon = new(0.6f, 0.6f, 0.6f, 1f);

  /// <summary>Uncommon item</summary>
  public static readonly Color ColorRarityUncommon = new(0.3f, 0.7f, 0.3f, 1f);

  /// <summary>Rare item</summary>
  public static readonly Color ColorRarityRare = new(0.3f, 0.5f, 0.9f, 1f);

  /// <summary>Epic item</summary>
  public static readonly Color ColorRarityEpic = new(0.7f, 0.4f, 0.9f, 1f);

  /// <summary>Legendary item</summary>
  public static readonly Color ColorRarityLegendary = new(1f, 0.7f, 0.2f, 1f);
