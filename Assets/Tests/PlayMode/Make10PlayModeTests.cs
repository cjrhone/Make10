...
public class Make10PlayModeTests {
  ...
  public IEnumerator ArcadeSwap_CompletesLine_ScoresAndResolves() {
    ...
    var gw = grid.GridColumns;
    var gh = grid.GridRows;
    ...
    var tileA = grid.GetTileAt(0, 0); // value 3
    var tileB = grid.GetTileAt(1, 0); // value 6 (horizontal neighbor)
    var scoreBefore = gm.Score;
